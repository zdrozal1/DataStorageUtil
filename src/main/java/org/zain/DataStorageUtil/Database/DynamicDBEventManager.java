...
public class DynamicDBEventManager {
	private Consumer<String> onDatabaseConnected = dbPath -> System.out.println("Connected to database at: " + dbPath);
	private Consumer<String> onDatabaseDeleted = dbName -> System.out.println("Deleted Database: " + dbName);
	...
	public void setOnDatabaseDeleted(Consumer<String> handler) {
		this.onDatabaseDeleted = handler;
	}
	...
	public void triggerDatabaseDeleted(String dbName) {
		onDatabaseDeleted.accept(dbName);
	}
